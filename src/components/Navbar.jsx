            ...
            <nav>
                ...
                <ul className={menuOpen ? "open" : ""}>
                    <CustomLink to="/topmovies">
                        <img src="https://assets.dougkarda.com/images/icons/icon-movielist-trans.png"
                            alt="Top Movies icon" />
                    ...
                    <CustomLink to="/starwarswatchlist">
                        <img src="https://assets.dougkarda.com/images/icons/icon-starwars-trans.png"
                            alt="Star Wars icon" />
                    ...
                    <CustomLink to="/MusicCalendar">
                        <img src="https://assets.dougkarda.com/images/icons/icon-concerts-trans.png"
